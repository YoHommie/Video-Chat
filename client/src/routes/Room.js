...
//                     </ButtonContainer>
//                     <ButtonContainer>
//                         <ButtonDisonnect className="disconnec" onClick={handleLeaveMeeting}>Leave Meeting</ButtonDisonnect>
//                     </ButtonContainer>
//                 </Container>
//             ) : (
//                 <FormContainer>
...
const Room = (props) => {
    ...
    const check = () => async () => {
        try {
            if (role === 'host') {
                let response= await axios.post(`${DSS_URL}/api/meeting/verifyParticipant`, { meetingID: meetingID, clientID: clientID, offerID: offer, participant: username, type: 'host' });
                ...
                let response= await axios.post(`${DSS_URL}/api/meeting/verifyParticipant`, { meetingID: meetingID, offerID: offer, participant: username, type: 'participant' });
                if (response.data.verified) {
                    setValidCheck(true);
                    setChecked(true);
                } else {
        ...
        <>
            {validCheck ? (
                ...
                >
                    ...
                    <ButtonContainer>
                        <ButtonDisconnect className="disconnect" onClick={handleLeaveMeeting}>Leave Meeting</ButtonDisconnect>
                    </ButtonContainer>
                </Container>
            ) : (
                <FormContainer>
